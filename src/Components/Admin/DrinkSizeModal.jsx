...
export default function DrinkSizeModal({
  open,
  onClose,
  form,
  setForm,
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 flex items-center justify-center p-4" style={{margin: 0}}>
      <div className="w-full max-w-md rounded-2xl bg-[#181818] border border-[#2d2d2d]">
        ...
        <div className="flex items-center justify-between px-6 py-5 border-b border-[#2d2d2d]">
          <h2 className="text-xl font-bold">
            {editing ? "Cập nhật size nước uống" : "Thêm size nước uống"}
          </h2>
